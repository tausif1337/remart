...
const MOCK_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    rating: 4.6,
    description: 'Sleek wireless keyboard with mechanical switches for a premium typing experience. Features long battery life and customizable RGB lighting.',
    specifications: [
  ...
  },
  {
    ...
    price: 59.99,
    category: 'electronics',
    image: 'https://images.unsplash.com/photo-1598436908734-73bae32a3b34?q=80&w=1000&auto=format&fit=crop',
    rating: 4.7,
    description: 'High-precision gaming mouse with programmable buttons and adjustable DPI settings. Ergonomic design for extended use.',
    specifications: [
  ...
  },
  {
    ...
    price: 199.99,
    category: 'furniture',
    image: 'https://images.unsplash.com/photo-1550966872-44e3d2b0e465?q=80&w=1000&auto=format&fit=crop',
    rating: 4.4,
    description: 'Modern coffee table with a minimalist design. Features a tempered glass top and solid wood legs for durability.',
    specifications: [
  ...
  },
  {
    ...
    price: 34.99,
    category: 'sports',
    image: 'https://images.unsplash.com/photo-1576671418898-8a6c3d68e641?q=80&w=1000&auto=format&fit=crop',
    rating: 4.3,
    description: 'Non-slip yoga mat with extra cushioning for comfort during workouts. Eco-friendly material with carrying strap included.',
    specifications: [
  ...
  },
  {
    ...
    price: 129.99,
    category: 'electronics',
    image: 'https://images.unsplash.com/photo-1613047508032-34a0d5935d9a?q=80&w=1000&auto=format&fit=crop',
    rating: 4.5,
    description: 'Portable Bluetooth speaker with 360-degree sound and deep bass. Waterproof design for outdoor use.',
    specifications: [
  ...
  },
  {
    ...
    price: 29.99,
    category: 'furniture',
    image: 'https://images.unsplash.com/photo-1596466596120-2a8e4b5d2c3a?q=80&w=1000&auto=format&fit=crop',
    rating: 4.1,
    description: 'Elegant desk organizer with multiple compartments to keep your workspace tidy and efficient.',
    specifications: [
  ...
  },
  {
    ...
    rating: 4.7,
    description: 'Lightweight running shoes with responsive cushioning and breathable mesh upper. Perfect for daily runs and gym sessions.',
    specifications: [
  ...
  },
  {
    ...
    rating: 4.4,
    description: 'Durable backpack with laptop compartment and multiple pockets. Water-resistant material for all weather conditions.',
    specifications: [
  ...
  },
  {
    ...
    rating: 4.3,
    description: 'Stylish sunglasses with UV protection and polarized lenses. Lightweight frame for all-day comfort.',
    specifications: [
  ...
  },
  {
    ...
    rating: 4.8,
    description: 'Latest smartphone with high-resolution camera, long battery life, and fast processing power.',
    specifications: [
  ...
  },
  {
    ...
    rating: 4.9,
    description: 'Powerful laptop with high-performance processor, perfect for work and entertainment. Lightweight and portable.',
    specifications: [
  ...
  },
  {
    ...
    price: 599.99,
    category: 'furniture',
    image: 'https://images.unsplash.com/photo-1556228453-efd17c9d9b39?q=80&w=1000&auto=format&fit=crop',
    rating: 4.6,
    description: 'Solid wood dining table that seats 6 people. Rustic design with durable finish.',
    specifications: [
  ...
  },
  {
    ...
    price: 79.99,
    category: 'electronics',
    image: 'https://images.unsplash.com/photo-1574842268427-9a3f03d0d401?q=80&w=1000&auto=format&fit=crop',
    rating: 4.2,
    description: 'Track your steps, heart rate, and sleep patterns with this affordable fitness tracker.',
    specifications: [
  ...
  },
  {
    ...
    rating: 4.5,
    description: 'Comfortable everyday sneakers with cushioned sole and breathable material. Available in multiple colors.',
    specifications: [
  ...
  },
  {
    ...
    rating: 4.7,
    description: 'Warm winter jacket with waterproof outer layer and insulated interior. Perfect for cold weather.',
    specifications: [
  ...
  },
  {
    ...
    price: 39.99,
    category: 'home',
    image: 'https://images.unsplash.com/photo-1609434263767-49dbb224ecda?q=80&w=1000&auto=format&fit=crop',
    rating: 4.0,
    description: 'Quiet desk fan with adjustable height and multiple speed settings. Perfect for personal cooling.',
    specifications: [
  ...
  },
  {
    ...
    rating: 4.4,
    description: 'Powerful blender for smoothies and food preparation. Multiple speed settings and large capacity.',
    specifications: [
...
const MOCK_REVIEWS: Review[] = [
  ...
  },
  {
    ...
    rating: 4,
    comment: 'Great support and adjustable features. The armrests could be more padded.',
    date: 'Nov 15, 2025',
  },
  {
    id: 'r5',
    ...
    rating: 5,
    comment: 'Perfect for tracking my fitness goals. The GPS accuracy is impressive.',
    date: 'Oct 20, 2025',
  },
  {
    id: 'r6',
    ...
    rating: 4,
    comment: 'Stylish and functional. Battery life could be better but overall very satisfied.',
    date: 'Sep 30, 2025',
  },
  {
    id: 'r7',
    ...
    rating: 4,
    comment: 'Beautiful minimalist design that fits perfectly with my desk setup.',
    date: 'Nov 22, 2025',
  },
  {
    id: 'r8',
    ...
    rating: 5,
    comment: 'The mechanical switches feel great and the RGB lighting is a nice touch.',
    date: 'Dec 5, 2025',
  },
  {
    id: 'r9',
    ...
    rating: 4,
    comment: 'Precise tracking and comfortable grip. Perfect for long gaming sessions.',
    date: 'Oct 18, 2025',
  },
  {
    id: 'r10',
    ...
    rating: 4,
    comment: 'Solid construction and modern look. Perfect size for my living room.',
    date: 'Nov 10, 2025',
  },
  {
    id: 'r11',
    ...
    rating: 5,
    comment: 'Great cushioning and non-slip surface. Really helps with my yoga practice.',
    date: 'Sep 25, 2025',
  },
  {
    id: 'r12',
    ...
    rating: 4,
    comment: 'Excellent sound quality and good battery life. Waterproof feature is great.',
    date: 'Oct 30, 2025',
  },
  {
    id: 'r13',
    ...
    rating: 4,
    comment: 'Keeps my desk organized and looks professional. Good value for money.',
    date: 'Nov 18, 2025',
  },
  {
    id: 'r14',
    ...
    rating: 5,
    comment: 'Perfect for running! The cushioning provides great support for long distances.',
    date: 'Dec 8, 2025',
  },
  {
    id: 'r15',
  ...
  },
  {
    ...
    rating: 4,
    comment: 'Spacious and well-organized. Perfect for daily commute and travel.',
    date: 'Nov 12, 2025',
  },
  {
    id: 'r17',
    ...
    rating: 5,
    comment: 'Great UV protection and stylish design. Very comfortable to wear.',
    date: 'Sep 20, 2025',
  },
  {
    id: 'r18',
    ...
    rating: 4,
    comment: 'Excellent camera quality and performance. Battery life could be better.',
    date: 'Oct 15, 2025',
  },
  {
    id: 'r19',
    ...
    rating: 5,
    comment: 'Powerful performance and beautiful display. Perfect for work and entertainment.',
    date: 'Nov 28, 2025',
  },
  {
    id: 'r20',
    ...
    rating: 4,
    comment: 'Solid wood construction and beautiful finish. Great for family dinners.',
    date: 'Dec 15, 2025',
  },
  {
    id: 'r21',
    ...
    rating: 4,
    comment: 'Good fitness tracking features at an affordable price. Display is clear.',
    date: 'Oct 5, 2025',
  },
  {
    id: 'r22',
    ...
    rating: 5,
    comment: 'Very comfortable for everyday wear. Good quality materials and construction.',
    date: 'Nov 2, 2025',
  },
  {
    id: 'r23',
    ...
    rating: 4,
    comment: 'Warm and waterproof. Perfect for winter activities and cold weather.',
    date: 'Dec 20, 2025',
  },
  {
    id: 'r24',
    ...
    rating: 4,
    comment: 'Quiet operation and adjustable height. Provides great relief during hot days.',
    date: 'Oct 10, 2025',
  },
  {
    id: 'r25',
    ...
    rating: 4,
    comment: 'Powerful motor and large capacity. Perfect for making smoothies and soups.',
    date: 'Nov 25, 2025',
  },
];
