      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }} className="px-6 py-12" keyboardShouldPersistTaps="handled">
        ...
        >
          {loading ? (
            ...
            <Text className="text-white font-outfit-bold text-lg">Sign In</Text>
          )}
        </TouchableOpacity>

        <View className="flex-row justify-center mt-8">
          <Text className="text-slate-500 font-outfit-regular">Don't have an account? </Text>
          <TouchableOpacity onPress={() => navigation.navigate('Register')}>
            <Text className="text-indigo-600 font-outfit-bold">Sign Up</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </SafeAreaView>
